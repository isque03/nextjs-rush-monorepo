...
echo -e "${BLUE}Scaffolding Next.js + Shared Library Monorepo${NC}"
echo ""
echo -e "${CYAN}This script will create the following directory structure and files:${NC}"
echo ""
echo "Directories:"
echo "  - apps/web-app/src/app/"
echo "  - libraries/shared-lib/src/"
echo "  - common/config/rush/"
echo "  - common/git-hooks/"
echo ""
echo "Configuration files:"
echo "  - rush.json"
echo "  - .gitignore"
echo "  - apps/web-app/package.json"
echo "  - apps/web-app/next.config.ts"
echo "  - apps/web-app/tsconfig.json"
echo "  - libraries/shared-lib/package.json"
echo "  - libraries/shared-lib/tsconfig.json"
echo "  - common/config/rush/*.json (Rush configuration files)"
echo "  - common/config/rush/.npmrc"
echo "  - common/config/rush/.pnpmfile.cjs"
echo ""
echo "Source files:"
echo "  - apps/web-app/src/app/page.tsx"
echo "  - apps/web-app/src/app/layout.tsx"
echo "  - apps/web-app/src/app/globals.css"
echo "  - libraries/shared-lib/src/SharedComponent.tsx"
echo "  - libraries/shared-lib/src/index.ts"
echo ""
echo -e "${YELLOW}Note:${NC} The following will be auto-generated by Rush/Next.js (not created by this script):"
echo "  - common/scripts/* (generated by Rush during rush update)"
echo "  - common/temp/* (generated by Rush during rush update)"
...
if command -v rush &> /dev/null; then
    ...
    rush update || {
        echo ""
        echo -e "${YELLOW}⚠️  rush update encountered an error. This might be expected if Rush needs to be installed first.${NC}"
        echo ""
    }
else
    echo -e "${YELLOW}⚠️  Rush.js not found. Skipping automatic setup.${NC}"
    echo ""
fi
